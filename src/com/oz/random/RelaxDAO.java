...
public class RelaxDAO {
	...
	public static void getRelax(HttpServletRequest request) {
		...
		try {
			...
			String sql = "select * from travel_Rel where t_placeNo = ?";
	...
	public static void upd(HttpServletRequest request) {
		...
		try {
			...
			String sql = "insert into travel_Rel values (travel_Rel_seq.nextval,?,?,?,?,?,?,?,?)";
